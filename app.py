...
# TO/DO:DONE : connect to a local postgresql database 
...
def venues():
  ...
  #   }]
  # }]
  data = [ venue.list for venue in Venue.query.distinct(Venue.city, Venue.state).all() ]
...
def show_artist(artist_id):
  ...
  try:
      ...
      print(artist.format_with_shows)
  except NoResultFound:
      abort(404)
...
def edit_artist(artist_id):
  ...
  # TO/DO: populate form with fields from artist with ID <artist_id>
...
def edit_venue(venue_id):
  ...
  # TO/DO: populate form with values from venue with ID <venue_id>
...
def create_show_submission():
  ...
  # TO/DO: insert form data as a new Show record in the db, instead
  try:
    show = Show(
